...
public class ShiftManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        else _currentShiftIndex = PersistentGameInfo.Instance.isTutorial ? -1 : 4;
    ...
    private void InitializeShift()
    {
        ...
        _audioManager.globalMusicAudioSource.DOFade(1f, 0.5f);
        _currentShiftIndex++;
        ...
        switch (_currentShiftIndex)
        {
            case 0:
                ...
                break;
            case 1:
                // enable info button, use all customer types
